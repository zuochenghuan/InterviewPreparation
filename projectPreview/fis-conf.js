// <!--param start-->
    //修改cdn的绝对路径（测试环境）
    fis.set('cdn-path','https://test.nie.163.com/test_cdn/z/pc/zt/20180211180739');
    //修改cdn的绝对路径（正式环境）
    fis.set('cdn-path-release','https://z.res.netease.com/pc/zt/20180211180739');
    //修改雪碧图放大缩小倍数，默认是1，iphone是0.5
    fis.set('css-scale',1);
    //修改include文件的域名
    fis.set('include-host','http://z.163.com/')
    // fis.set('livereload.hostname', '10.242.96.171');
    fis.set('livereload.hostname', '192.168.199.199');
...
fis.media('dist')
    ...
    .match('*.{js,css,less,png,jpg,jpeg,gif,mp3,mp4,webm,flv,swf,svg,eot,ttf,woff}',{
